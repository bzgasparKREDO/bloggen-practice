    ...
    <main class="container w-50 ">
        <div class="row mb-4">
            ...
            <div class="col-4 text-end ">
                <form method="post">
                    <button type="submit" name="btn_delete" style="font-size: 1em" class="btn btn-outline-danger"><i class="fa-solid fa-trash-can"></i>
                        Delete Post</button>
                </form>
            </div>
        </div>
        ...
        <article class="bg-light p-3">
            <div class="row mb-2">
                <a href="edit-post.php?post_id=<?= $_GET['post_id'] ?>"
                    class="text-secondary col text-end text-decoration-none"><i
                        class="fa-solid mx-1 fa-pen me-1"></i>Edit</a>
            </div>
            <h1 class="display-6"><?= $post_row['post_title'] ?></h1>
            <p class="small">
